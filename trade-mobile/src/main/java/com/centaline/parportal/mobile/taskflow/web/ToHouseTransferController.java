...
public class ToHouseTransferController {
    ...
    @ResponseBody
    public AjaxResponse submitToHouseTransfer(ToHouseTransfer toHouseTransfer,ToMortgage toMortgage,LoanlostApproveVO loanlostApproveVO,String taskId,String processInstanceId) {
