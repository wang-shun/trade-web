...
(function ($, window, document, undefined) {
    ...
    TwbsPagination.prototype = {
        ...
        buildShowButtonItem:function(elem,pages)
        {
            if (this.options.showGoto)
            {
                $('#pagerGotodiv').remove();
                var div=$('<div id="pagerGotodiv"><span>跳转至:</span></div>');
                var input=$('<input type="text"  value="" />');
                var button=$('<input type="button" value=""/>');
                $(input).addClass(this.options.showGotoInputClass);
                $(div).addClass(this.options.showGotoContentClass);
                $(button).addClass(this.options.showGotoButtonClass);
                $(button).val(this.options.showGotoButtonText);
                var currentPage=pages.currentPage;
                if (currentPage>=1 && currentPage<=this.options.totalPages)
                {
                    $(input).val(currentPage);
                }
                else if (currentPage>this.options.totalPages)
                {
                    $(input).val(this.options.totalPages);
                }
                else
                {
                    $(input).val(1);
                ...
                $(button).click($.proxy(function(e){
                    ...
                    this.options.onPageClick(e,page);
                },this));
                $(div).append(input);
                $(div).append(button);
                $(elem).after(div);
        ...
        render: function (pages) {
            ...
            //bobin
            this.buildShowButtonItem(this.$listContainer,pages);
            //end
...
//        //柏彬修改
    ...
    $.fn.twbsPagination.defaults = {
        ...
        showGotoInputClass:'',
        showGotoButtonClass:'',
        showGotoContentClass:'',
        showGotoButtonText:'GO'
    };
