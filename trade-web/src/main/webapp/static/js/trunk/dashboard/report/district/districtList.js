...
$(document).ready(function() {
	var url = "/report/district/countData";
	url = ctx + url;
...
function searchCount(){
	...
	var url = "/report/district/countData?startDate="+startDate+"&endDate="+endDate;
	url = ctx + url;
		  $.ajax({
				cache : false,
				async : false,
...
//加载报表数据
function dInitMorris(){
	var orgId  = $("#orgId").val();
	var events = [];
	$.ajax({
		url:ctx+'/report/district/getCaseCount?orgId='+orgId,
		data: "",
		type: "GET",
		dataType: "json",
		async : false,
