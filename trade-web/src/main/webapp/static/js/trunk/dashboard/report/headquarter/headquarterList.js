...
$(document).ready(function() {
	var url = "/report/headquarter/countData";
	url = ctx + url;
...
function searchCount(){
	...
	var url = "/report/headquarter/countData?startDate="+startDate+"&endDate="+endDate;
	url = ctx + url;
		  $.ajax({
				cache : false,
				async : false,
...
function initMorris(){
	...
	var events = [];
	$.ajax({
		url:ctx+'/report/headquarter/getCaseCount?orgId='+orgId,
		data: "",
		type: "GET",
		dataType: "json",
		async : false,
