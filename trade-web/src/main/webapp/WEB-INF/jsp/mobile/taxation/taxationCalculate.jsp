...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/static/momedia/css/taxation/taxationCalculate.css' />" />
</head>
<body>
...
<script type="text/javascript" src="<c:url value='/static/momedia/js/number.js' />"></script>
<script>
$(function () {
    //获取jQuery 对象
    var $popup = $("#Popup");
