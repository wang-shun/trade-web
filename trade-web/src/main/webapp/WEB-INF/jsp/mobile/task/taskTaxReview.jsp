			...
			<div class="ibox-content">
				<form method="get" class="form-horizontal" id="tasReviewForm">
					...
					<div class="form-group" id="data_1">
						...
						<div class="col-sm-10">
								<input type="date" class="form-control" id="taxTime"
									name="taxTime" value="<fmt:formatDate  value='${taxReview.taxTime}' type='both' pattern='yyyy-MM-dd'/>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<aist:dict clazz="form-control m-b" id="isUniqueHome" name="isUniqueHome" display="select" defaultvalue="${taxReview.isUniqueHome}" dictType="is_unique_home" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<aist:dict clazz="form-control m-b" id="holdYear" name="holdYear" display="select" defaultvalue="${taxReview.holdYear}" dictType="hold_year" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="comment" name="comment" value="${taxReview.comment}">
						</div>
					</div>
				</form>
