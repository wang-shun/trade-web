			...
			<div class="ibox-content">
				<form method="get" class="form-horizontal" id="purchaseLimitForm">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">查限购时间<font color="red">*</font></label>
						<div class="col-sm-10">
								<input type="date" class="form-control" id="realPlsTime"
									name="realPlsTime" value="<fmt:formatDate  value='${purchaseLimit.realPlsTime}' type='both' pattern='yyyy-MM-dd'/>">
						</div>
