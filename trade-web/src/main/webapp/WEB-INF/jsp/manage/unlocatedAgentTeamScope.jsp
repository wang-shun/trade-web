...
<body>
	...
	<div class="ibox-content">	
  	...
  	<content tag="local_script">
		...
		<script src="<c:url value='/transjs/manage/unlocatedAgentTeamList.js' />"></script>
		<jsp:include page="/WEB-INF/jsp/tbsp/common/userorg.jsp"></jsp:include>	
	<%-- <script src="<c:url value='/transjs/manage/teamScope.js' />"></script>  --%>
