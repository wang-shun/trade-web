							...
							ligerui='none' defaultvalue=""></aist:dict>
                              ...
                              <div class="line">
                                <div class="form_content">
                                    ...
                                    <textarea class="select_control sign_right_two" value="${toRcMortgageVO.rcRiskControl.riskComment }" id="riskComment" name="riskComment" style="width:400px;height:100px; display:block;margin-left:124px"></textarea>
                                </div>
                            </div> 
                        </form>
