                        ...
                        <form class="form_list" id="mortgageForm">
                            ...
                            <div class="line">
                                <div class="form_content">
                                    ...
                                    <textarea disabled="disabled" class="select_control sign_right_two" id="riskComment" name="riskComment" style="width:400px;height:100px; display:block;margin-left:124px">${toRcMortgageVO.rcRiskControl.riskComment }</textarea>
                                </div>
                            </div>
                            ...
                            <div class="line" id="addTr">
                                ...
                                <div class="entry">
                                    <div class="form_content">
                                        ...
                                        <input disabled="disabled" type="text" placeholder="" class="select_control sign_right_one" id="referCode" name="referCode" value="${item.referCode}">
                                    </div>
                                    <div class="form_content">
                                        <label class="control-label sign_left_small">
                                            产权人姓名
                                        </label>
                                        <input disabled="disabled" type="text" placeholder="" class="select_control teamcode" id="referName" name="referName" value="${item.referName}">
                                    </div>
                                    <div class="form_content">
                                        <label class="control-label sign_left_small">
                                            房屋地址
                                        </label>
                                        <input disabled="disabled" type="text" placeholder="" class="select_control teamcode" id="referAddreass" name="referAddreass" value="${item.referAddreass}">
                                    </div>
                                </div>
                                <div class="entry" style="display:none;">
                                    <div class="form_content">
                                        ...
                                        <input disabled="disabled" type="text" placeholder="" class="select_control sign_right_one" id="referCode" name="referCode" value="">
                                    </div>
                                    <div class="form_content">
                                        <label class="control-label sign_left_small">
                                            他项权利人
                                        </label>
                                        <input disabled="disabled" type="text" placeholder="" class="select_control teamcode" id="referName" name="referName" value="">
                                    </div>
                                    <div class="form_content">
                                        <label class="control-label sign_left_small">
                                            房屋地址
                                        </label>
                                        <input disabled="disabled" type="text" placeholder="" class="select_control teamcode" id="referAddreass" name="referAddreass" value="">
                                    </div>
                                </div>
                                </c:if>
