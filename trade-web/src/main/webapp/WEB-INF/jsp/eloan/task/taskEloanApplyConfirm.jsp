						...
						ligerui='none' defaultvalue="${eloanCase.loanSrvCode}"></aist:dict>
                            ...
                            <li>
                                ...
                                <div class="form_content input-daterange" data-date-format="yyyy-mm-dd">
                                    <label class="control-label sign_left_two">
                                     ...
                                     <input class="input_type sign_right_two" name="month" id="month" value="<fmt:formatDate value="${eloanCase.applyTime}" pattern="yyyy-MM-dd" />">
                                    <div class="input-group date_icon">
                            ...
                            <li>
                                <div class="form_content">
                                    ...
                                    <input class="input_type sign_right_two" name="zjName" id="zjName" value="${eloanCase.zjName}">
                                </div>
                                <div class="form_content">
                                    <label class="control-label sign_left_two">
                                        转介人员工编号
                                    </label>
                                    <input class="input_type sign_right_two" name="zjCode" id="zjCode" value="${eloanCase.zjCode}">
                                </div>
                            ...
                            <li>
                                <div class="form_content">
                                    ...
                                    <input class="input_type sign_right_two" name="pdName" id="pdName" value="${eloanCase.pdName}">
                                </div>
                                <div class="form_content">
                                    <label class="control-label sign_left_two">
                                        产品部员工编号
                                    </label>
                                    <input class="input_type sign_right_two" name="pdCode" id="pdCode" value="${eloanCase.pdCode}">
                                </div>
                                <div class="form_content">
                                    <label class="control-label sign_left_two">
                                        分成比例贷款
                                    </label>
                                    <input class="input_type sign_right_two" name="pdPart" id="pdPart" value="${eloanCase.pdPart}">
                                    <div class="input-group date_icon">
                            ...
                            <li>
                                <div class="form_content">
                                    ...
                                    <input class="input_type sign_right_two" name="coName" id="coName" value="${eloanCase.coName}">
                                </div>
                                <div class="form_content">
                                    <label class="control-label sign_left_two">
                                        合作人员工编号
                                    </label>
                                    <input class="input_type sign_right_two" name="coCode" id="coCode" value="${eloanCase.coCode}">
                                </div>
                                <div class="form_content">
                                    <label class="control-label sign_left_two">
                                        分成比例贷款
                                    </label>
                                    <input class="input_type sign_right_two" name="coPart" id="coPart" value="${eloanCase.coPart}">
                                    <div class="input-group date_icon">
                                        <span class="danwei">%</span>
                                    </div>
                                </div>
			 ...
			 $.ajax({
		    	...
		    	success:function(data){
		    		if(data.bankList != null){
		    			...
		    			friend.find("option[value='${eloanCase.finOrgCode }']").attr("selected",true);
		    		}
		    	}
			  });
		}
