...
<!-- stickUp fixed css -->
<link href="${ctx}/css/plugins/stickup/stickup.css" rel="stylesheet">
<link href="${ctx}/css/trans/css/common/stickDash.css" rel="stylesheet">

<link href="${ctx}/css/plugins/aist-steps/steps.css" rel="stylesheet">
<link href="${ctx}/css/plugins/toastr/toastr.min.css" rel="stylesheet">
<link href="${ctx}/css/plugins/datapicker/datepicker3.css" rel="stylesheet">
<link href="${ctx}/css/plugins/chosen/chosen.css" rel="stylesheet">
<!-- index_css  -->
<link href="${ctx}/css/trans/css/eloan/eloan.css"
	rel="stylesheet" />
<link href="${ctx}/css/trans/css/common/input.css" rel="stylesheet" />
<link href="${ctx}/css/trans/css/common/table.css" rel="stylesheet" />
<link href="${ctx}/css/common/hint.css" rel="stylesheet" />
<!-- 分页控件 -->
...
<body>
		...
		<div class="row">
			<div class="ibox-content border-bottom clearfix space_box">
				...
				<%-- 	<div class="form_content">
					...
					<div class="form_content">
					<div id="dateDiv_0">
						 <select id="sel_time" class="select_control">
						...
						<div id="datepicker_0"
											...
											<input id="dtBegin_0" name="dtBegin" class="form-control data_style"
												type="text" value="" placeholder="起始日期"> <span
												class="input-group-addon">到</span> <input id="dtEnd_0"
												name="dtEnd" class="form-control data_style"
												type="text" value="" placeholder="结束日期">
						</div>
						</div>
					</div>
					<div class="form_content pull-right">
						<label class=""> 案件信息 </label> <select
							id="sel_caseInfo" class="select_control sign_right_one">
					...
					<div class=" btn-sign pull-right">
						...
						<i class="icon_add iconfont">&#xe617;</i>&nbsp;新增 
					</a>
						</div>
					</div>
				</form>
	...
	<script	src="${ctx}/js/plugins/chosen/chosen.jquery.js"></script> <!-- iCheck -->
	  ...
	  //查询数据
	    $("#btn_search").click(function() {
	    	...
	    	if(sel_time=="applyTime"){
	    		params.search_applyTimeStart=$("input[name='dtBegin']").val();
	    		params.search_applyTimeEnd=$("input[name='dtEnd']").val();
	    	}else if(sel_time=="releaseTime"){
	    		params.search_releaseTimeStart=$("input[name='dtBegin']").val();
	    		params.search_releaseTimeEnd=$("input[name='dtEnd']").val();
	    	}else{
	    		params.search_signTimeStart=$("input[name='dtBegin']").val("");
	    		params.search_signTimeEnd=$("input[name='dtEnd']").val();
	    	}
	    	var sel_caseInfo=$("#sel_caseInfo").val();
	    	if(sel_caseInfo=="addr"){
	    		params.search_propertyAddr=$("#txt_caseInfo").val();
	    	}else if(sel_caseInfo=="custName"){
	    		params.search_custName=$("#txt_caseInfo").val();
	    	}
