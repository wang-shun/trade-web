...
<!-- 必须CSS -->
<link rel="stylesheet"
	href="<c:url value='/js/poshytitle/src/tip-twitter/tip-twitter.css' />"
	type="text/css" />
...
<body>
	...
	<content tag="local_script"> <!-- js模板引擎 --> <script
		src="<c:url value='/static/js/template.js' />"></script> <!-- 分页控件  --> <script
		src="<c:url value='/static/js/plugins/pager/jquery.twbsPagination.min.js' />"></script>
	<!-- 自定义扩展jQuery库 --> <script src="<c:url value='/js/plugins/jquery.custom.js' />"></script>
	<script src="<c:url value='/js/jquery.blockui.min.js' />"></script> <!-- 	<script src="<c:url value='/static/trans/js/property/aist.jquery.custom.ps.js' />"></script> -->
	<script src="<c:url value='/js/plugins/aist/aist.jquery.custom.js' />"></script> <!-- datapicker -->
	<script
		src="<c:url value='/static/js/plugins/datapicker/bootstrap-datepicker.js' />"></script>

	<!-- 必须JS --> <script src="<c:url value='/js/poshytitle/src/jquery.poshytip.js' />"></script>
	<!-- owner --> <script src="<c:url value='/js/trunk/eloan/eloanRiskCtlList.js' />"></script>
