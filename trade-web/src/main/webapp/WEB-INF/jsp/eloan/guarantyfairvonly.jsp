...
<body>
	...
	<content tag="local_script"> <!-- Mainly scripts --> <!--<script src="<c:url value='/static/js/jquery-2.1.1.js' />"></script>
	...
	<!-- Custom and plugin javascript --> <script
		src="<c:url value='/static/js/inspinia.js' />"></script> <script
		src="<c:url value='/static/js/plugins/pace/pace.min.js' />"></script> <script
		type="text/javascript"
		src="<c:url value='/static/trans/js/plugins/poshytip/jquery.poshytip.js' />"></script>
	<script
	...
	<script src="<c:url value='/static/trans/js/eloan/eloan_guarant.js' />"></script> <!-- 上传附件相关 -->
	...
	<!-- 附件保存修改相关 --> <script src="<c:url value='/js/trunk/eloan/attachmentvonly.js' />"></script>
