...
<div id="fullpage">
    <div class="section " id="section0">
        <iframe id="iframe1" src="${ctx}/report/sign1" width="100%" height="100%" frameborder="0" scrolling="no" name=""></iframe>
    </div>
    <div  class="section" id="section1">
        <iframe id="iframe2" src="${ctx}/report/sign2" width="100%" height="100%" frameborder="0" scrolling="no" name=""></iframe>
    </div>
    <div class="section" id="section2">
        <iframe id="iframe3" src="${ctx}/report/sign3" width="100%" height="100%" frameborder="0" scrolling="no" name=""></iframe>
    </div>
    <div class="section" id="section3">
        <iframe id="iframe4" src="${ctx}/report/sign4" width="100%" height="100%" frameborder="0" scrolling="no" name=""></iframe>
    </div>
    <div class="section" id="section4">
        <iframe id="iframe5" src="${ctx}/report/sign5" width="100%" height="100%" frameborder="0" scrolling="no" name=""></iframe>
    </div>
    <div class="section" id="section5">
        <iframe id="iframe6" src="${ctx}/report/sign6" width="100%" height="100%" frameborder="0" scrolling="no" name=""></iframe>
    </div>
...
var iframesArr = [iframe1,iframe2,iframe3,iframe4,iframe5,iframe6];
