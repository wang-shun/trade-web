...
<script>
		...
		jQuery(document).ready(function() {
			...
			data.queryId = "exportCaseRejectionRateList";
			data.rows = 10;
			data.page = 1;
		...
		function loanLostApproveSearchMethod(page) {
			...
			params.page = page;
			params.rows = 10;
			params.queryId = "exportCaseRejectionRateList";
			reloadGrid(params);
		};
		...
		//案件excel导出
			...
			aist.exportExcel({
				ctx : "${ctx}",
				queryId : 'exportCaseRejectionRateList',
				colomns : [ 'ORGNAME', 'AMOUNT','NOT_APPROVE','APPROVE','RATE' ],
				data : data
			})
		} 
</script>
