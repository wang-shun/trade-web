...
<body>	
                        ...
                        <div class="ibox-content">
                            <form method="get" class="form-horizontal form-m">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    	<input type="text" id="knowledgeCode" name="knowledgeCode" readonly class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    	<input type="text" id="knowledgeTitle" name="knowledgeTitle" readonly class="form-control"> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    	<textarea rows="5" cols="5" id="knowledgeContent" name="knowledgeContent"  readonly class="form-control"></textarea> 
                                    </div>
                                </div>
                            ...
                            <div class="row-fluid">
								<a class="btn btn-primary" onclick="closeFancybox()" >关闭</a>
							</div>
                        </div>
                    </div>
                </div>
	...
	<content tag="local_script">
		...
		<script src="<c:url value='/js/trunk/knowledge/knowledgeDetail.js' />"></script>
		<script>
			jQuery(document).ready(function() {
				 knowledgeDetailLoadInit('${knowledgePkid}','${ctx}','${filesvr}'); 
				 App.init();
