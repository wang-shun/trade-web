...
<jsp:include page="/WEB-INF/jsp/common/taskListByCaseCode.jsp"></jsp:include>
        ...
        <div class="ibox-content border-bottom clearfix space_box noborder">
            ...
            <div class="form-btn">
                   <div class="text-center">
                       <button  class="btn btn-success btn-space"  id="btnSubmitFalse">拒绝</button>
                       <button  class="btn btn-success btn-space"  readOnlydata="1" id="btnSubmitTrue">接单</button>
                   </div>
	...
	<content tag="local_script"> 
		<script>
			...
			$("#btnSubmitFalse").click(function(){
				var data = 
				{
				   "caseCode":$("#caseCode").val(),
				   "isLonaerAcceptCase":false,
				   "taskId":"",
				   "processInstanceId":"",				  
				};
				
			 	$.ajax({
				    url:ctx+"/loaner/loanerApproveCase",
				    async:false,
			    	method:"post",
			    	dataType:"json",
			    	data:data,
			...
			$("#btnSubmitTrue").click(function(){
				var data = 
				{
					   "caseCode":$("#caseCode").val(),
					   "isLonaerAcceptCase":true,
					   "taskId":"",
					   "processInstanceId":"",
				 };		
