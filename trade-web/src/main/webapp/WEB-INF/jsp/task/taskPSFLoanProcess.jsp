...
<input type="hidden" id="conPrice" name="conPrice" value="${caseBaseVO.sign.conPrice }">
                          ...
                          <h3>公积金贷款申请页签</h3>
                                                <section style="background-color: #fff">
                                                    ...
                                                    <div class="form_list tmpBankHide nonTmpBankShow" style="margin-top: 0;" id='div_order'>
															...
															defaultvalue="" /> -->
															<input type="hidden" name="mortType" value="30016003"/>
                                                            </div>
                                                            </div>
                                                            <div class="line">
                                                            	<div class="form_content">
                                                            ...
                                                            <div class="line">
                                                             ...
                                                             <div class="line">
                                                                ...
                                                                <div class="form_content">
					                                             <label class="control-label sign_left_small2">信贷员电话</label>
 ...
 -->						<form id=mortgageForm_b>	
							...
							<h4>上传附件<br><div class="table-box" id="PSFLoanProcessfileUploadContainer"></div>
...
<!-- 上传附件结束 -->
<script src="<c:url value='/transjs/task/taskPSFLoanProcess.js' />?6"></script> 
 	...
 	jQuery(document).ready(function() {
		...
		$("#code").inputmask({"mask":"999999-999999-999"});
	 	...
	 	/* $("select[name='mortType']").each(function(){
			...
			$(this).find("option[value='30016003']")[0].selected = true;
		});  */
	    ...
	    require(['main'], function() {
			requirejs(['jquery','aistFileUpload','validate','grid','jqGrid','additional','blockUI','steps','ligerui','aistJquery','modal','modalmanager','twbsPagination'],function($,aistFileUpload){
				...
				fileUpload.init({
		    		...
		    		partCode : "PSFLoanProcess",
		    		preFileCode : "_letter_first",
		    		fileUploadContainer : "PSFLoanProcessfileUploadContainer"
		    	});
