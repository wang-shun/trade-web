			...
			<div class="ibox-content">
				<form method="get" class="form-horizontal" id="lamform">
					...
					<div class="form-group">
						...
						<div class="form_sign col-sm-12 clearfix" id="loanLostManagerNotApproves"
							style="display: none">
							<c:forEach items="${loanLostNotApproves}"
								var="loanLostManagerNotApprove">
								<div class="col-sm-6 sign">
									<input type="checkbox"
										value="${loanLostManagerNotApprove.code}"
										name="loanLostManagerNotApprove" class="btn btn-white"
										onClick="loanLostManagerAppendNotApprove(this.checked,'${loanLostManagerNotApprove.name}');">
									<label>${loanLostManagerNotApprove.name}</label>
								</div>
							</c:forEach>
						</div>
					</div> --%>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control"
								id="LoanLost_manager_response" name="LoanLost_manager_response"
								value="">
						</div>
					</div>
				</form>
