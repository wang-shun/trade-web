...
<jsp:include page="/WEB-INF/jsp/common/salesLoading.jsp"></jsp:include>
			...
			<div class="ibox-content">
				<form method="get" class="form-horizontal" id="lamform">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="radio i-checks radio-inline">
								<label> 
									<input type="radio" value="true" id="optionsRadios1" name="CaseCloseThirdCheck">审批通过
								</label>
								<label> 
									<input type="radio" checked="checked" value="false" id="optionsRadios2" name="CaseCloseThirdCheck">审批不通过
								</label>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="CaseCloseThirdCheck_response" name="CaseCloseThirdCheck_response" value="">
						</div>
					</div>
				</form>
	...
	<script>
		...
		function save() {
			...
			var url = "${ctx}/task/caselostApprove/caselostApproveThird";
