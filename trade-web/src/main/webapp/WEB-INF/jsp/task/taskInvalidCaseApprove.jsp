...
<jsp:include page="/WEB-INF/jsp/common/salesLoading.jsp"></jsp:include>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="radio i-checks radio-inline">
								<label> 
									<input type="radio" value="true" id="optionsRadios1" name="InvalidCaseApprove">审批通过
								</label>
								<label> 
									<input type="radio" checked="checked" value="false" id="optionsRadios2" name="InvalidCaseApprove">审批不通过
								</label>
							</div>
						</div>
					</div>
	...
	function save() {
		...
		var url = "${ctx}/task/invalidCaseApprove/invalidCaseApprove";
