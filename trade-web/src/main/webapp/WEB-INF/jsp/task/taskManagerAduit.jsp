		...
		<div class=" wrapper border-bottom white-bg page-heading">
			...
			<div class="row form-group">
				...
				<div class="col-md-4" style="height: 38px">
					<select name="bank_type" class="form-control" id="bank_type" ${jobCode ne 'Manager'?'disabled="true"':''} >
					</select>
				</div>
				...
				<div class="col-md-4" style="height: 38px">
					<select name="finOrgCode" class="form-control" id="finOrgCode" ${jobCode ne 'Manager'?'disabled="true"':''} >
					</select>
				</div>
			</div>
