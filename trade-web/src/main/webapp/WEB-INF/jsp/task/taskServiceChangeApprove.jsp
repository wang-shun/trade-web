				...
				<form method="get" class="form-horizontal" id="lamform">
					...
					<div class="form-group">
						...
						<div class="col-sm-8" style="margin-top: 8px;" >
							<span id="newxm">${newxm}</span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">删除的服务项</label>
						<div class="col-sm-8" style="margin-top: 8px;" >
							<span id="delxm">${delxm}</span> 
						</div>
					</div>
					<div class="form-group">
						...
						<div class="radio i-checks radio-inline">
							<label> 
								<input type="radio" value="false" id="optionsRadios2" name="Approve_Result">审批未通过
							</label>
						</div>
					</div>
					<div class="form-group">
