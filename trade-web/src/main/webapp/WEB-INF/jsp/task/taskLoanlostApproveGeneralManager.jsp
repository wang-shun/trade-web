...
<!-- 					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="radio i-checks radio-inline">
								<label> 
									<input type="radio" value="true" id="optionsRadios1" name="LoanLost_GeneralManager">审批通过
								</label>
								<label> 
									<input type="radio" checked="checked" value="false" id="optionsRadios2" name="LoanLost_GeneralManager">审批不通过
								</label>
							</div>
						</div>
					</div> -->
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="LoanLost_GeneralManager_response" 
