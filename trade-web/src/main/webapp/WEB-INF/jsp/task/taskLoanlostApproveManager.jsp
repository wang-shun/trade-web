			...
			<div class="ibox-content">
				<form method="get" class="form-horizontal" id="lamform">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="radio i-checks radio-inline">
								<label> 
									<input type="radio" value="true" id="optionsRadios1" name="LoanLost_manager">审批通过
								</label>
								<label> 
									<input type="radio" checked="checked" value="false" id="optionsRadios2" name="LoanLost_manager">审批不通过
								</label>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="LoanLost_manager_response" 
								name="LoanLost_manager_response" value="">
						</div>
					</div>
				</form>
