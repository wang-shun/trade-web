			...
			<div class="form_list">
				<div class="marinfo">
					<div class="line">
						<div class="form_content">
							<label class="control-label sign_left_small"><font
								...
								name="isNeedRecovery" id="need" value="1" checked="checked"> 需要
					...
					<div class="line" id="isNeedDiv">
						...
						<div class="form_content">
							<label class="control-label sign_left_small1">评估报告回收份数： </label> <input
								type="text" class="input_type yuanwid" id="reportBackNum"
								maxlength="16" name="reportBackNum" value="${toEvaRefund.reportBackNum }">
						</div>

						<div class="form_content">
							<label class="control-label sign_left_small1">回收时间： </label> <input
								class="input_type yuanwid date-picker" style="font-size: 13px;"
								type="text" id="backTime" name="backTime"  value="<fmt:formatDate  value='${toEvaRefund.backTime}' type='both' pattern='yyyy-MM-dd'/>">
						</div>

						<div class="form_content">
							<label class="control-label sign_left_small1">未回收原因： </label> <input
					...
					<div class="line">
						<div class="form_content mt3">
							<label class="control-label sign_left_small1"><font
								...
								name="evalRealCharges" onkeyup="checkNum(this)" value="${toEvaRefund.evalRealCharges }"> <span>元</span>
						</div>
					</div>
