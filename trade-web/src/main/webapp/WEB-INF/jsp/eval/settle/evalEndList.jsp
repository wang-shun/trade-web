					...
					<div class="row date-info clearfix">
						<div class="form_content">
							<div id="dateDiv_0" style="padding-left:45px;">
								<label class="sign_left_two control-label">结算时间</label>
				...
				<div class="row clearfix">
					...
					<div class="row date-info clearfix">
						<div class="form_content">
							<div id="dateDiv_0" style="padding-left:45px;">
								<div class="sign_right big_pad">
									<select id="inTextType"  class="form-control select_control" data-placeholder="搜索条件设定" onchange="intextTypeChange()">
				...
				<td class="center">
					...
					<input type='hidden' name='taskIds' value="{{item.ID}}" disabled>
									...
									{{if item.EVA_PRICE!=null}}
						 				{{(item.EVA_PRICE/10000).toFixed()}}万元
					    			{{/if}}
									</td>	
