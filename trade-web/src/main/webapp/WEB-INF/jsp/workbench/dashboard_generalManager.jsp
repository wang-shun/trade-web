					...
					<div class="col-lg-12">
						<div class="panel blank-panel">
							<div class="panel-heading">
								<div class="panel-options">
									<ul class="nav nav-tabs">
										<li class="active"><a href="#tab-01" data-toggle="tab">业务提醒</a>
										</li>
										<li id="yewu" class=""><a href="#tab-02"
											data-toggle="tab">龙虎榜</a></li>
									</ul>
								</div>
							</div>
...
<%-- 															<c:forEach items="${rank.actualAmountRankList}"
	...
	<!-- iCheck --> <script
		src="<c:url value='/static/js/plugins/iCheck/icheck.min.js' />"></script> <!-- ECharts.js -->
	<script src="<c:url value='/static/js/echarts.min.js' />"></script> <!-- owner -->
	<script src="<c:url value='/static/trans/js/workbench/stickDash.js' />"></script> <script
