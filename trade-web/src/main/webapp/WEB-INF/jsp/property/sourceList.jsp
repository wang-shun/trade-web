...
<jsp:include page="/WEB-INF/jsp/common/salesLoading.jsp"></jsp:include>
	...
	<content tag="local_script"> <script
		src="<c:url value='/js/plugins/chartJs/echarts.js' />" type="text/javascript"></script>

	<!-- js模板引擎 --> <script src="<c:url value='/static/js/template.js' />"></script> <!-- 分页控件  -->
	<script
	...
	<!-- owner --> <script
		src="<c:url value='/js/trunk/property/propertySourceList.js' />"></script> <jsp:include
