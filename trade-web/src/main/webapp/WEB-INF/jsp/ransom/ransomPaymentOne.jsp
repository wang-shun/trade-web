...
<body>
	...
	<div class="ibox-content border-bottom clearfix space_box noborder">
	 	<form method="get" class="form_list text-center">
             <div class="line">
             	...
             	<div class="col-lg-12">
	                <div class="col-lg-6 form_content ">
	                    <label class="control-label select_style mend_select trim"><font color=" red" class="mr5" >*</font>陪同还贷时间(一抵)</label>
	                ...
	                <div class="col-lg-6 form_content">
	                    <label class="control-label select_style mend_select trim"><font color=" red" class="mr5" >*</font>注销抵押时间(一抵)</label>
	                    <div class="input-group sign-right dataleft input-daterange" data-date-format="yyyy-mm-dd" >
	                        <input name="changeTimeStart" id="changeTimeStart" class="form-control data_style" type="text" value="${curMonthStart }" placeholder="">
	                    </div>
	                </div>
             ...
             <div class="col-lg-12">
	                <div class="col-lg-6 form_content ">
	                    <label class="control-label select_style mend_select trim"><font color=" red" class="mr5" >*</font>回款时间(一抵)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
	                    <div class="input-group sign-right dataleft input-daterange" data-date-format="yyyy-mm-dd" >
	                        <input name="changeTimeStart" id="changeTimeStart" class="form-control data_style" type="text" value="${curMonthStart }" placeholder="">
	                    </div>
	                </div>
	...
	<script>
		$(document).ready(function() {
			...
			$("#submit").click(function(){
				window.location.href = ctx + "/ransomList/ransom/ransomMortgageOne";
			});
		});
	</script> 
</content>
