...
<body>
           		...
           		<div class="form-row form-rowbot clear">
	           		<div class="row clearfix">
						...
						<div class="form_content">
							...
							<input type="text" id="repayLoanMoney" name="repayLoanMoney"  value="${payloanVo.repayLoanMoney/10000 }"
							class="select_control yuanwid" style="width: 200px;" onkeyup="checkNum(this)">
	...
	$('#submitButton').click(function(){
		...
		var url = "${ctx}/ransomChange/saveMortagage";
		var caseCode = $("#caseCode").val();
		$.ajax({
			cache:true,
			async:false,
