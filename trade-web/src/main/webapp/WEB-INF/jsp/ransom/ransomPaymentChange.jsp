...
<body>
			...
			<div class="line">
			    ...
			    <div class="form_content ">
			        ...
			        <div class="input-group sign-right dataleft input-daterange" data-date-format="yyyy-mm-dd" >
			            <input id="paymentTime" name="paymentTime" class="form-control input-one date-picker data_style" 
			            value="<fmt:formatDate value='${paymentVo.paymentTime }' pattern='yyyy-MM-dd'/>"
			             style="font-size: 13px;width: 178px; border-radius: 2px;" type="text"  placeholder="回款结清时间" disabled="disabled">
			        </div>
			    </div>
			</div>
		</form>
	...
	<div class="ibox-content border-bottom clearfix space_box noborder">
		...
		<div class="add_btn text-center mt20">
	   	<div class="more_btn">
		    <button id="submitButton" type="button" class="btn btn_blue">保存</button>
