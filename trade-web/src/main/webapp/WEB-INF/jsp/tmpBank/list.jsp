...
<!-- index_css -->
 <link rel="stylesheet" href="<c:url value='/css/tmpBank/base.css' />" />
 <link rel="stylesheet" href="<c:url value='/css/tmpBank/table.css' />" />
 <link rel="stylesheet" href="<c:url value='/css/tmpBank/input.css' />" />
 <link rel="stylesheet" href="<c:url value='/css/tmpBank/iconfont/iconfont.css' />">
...
<body>
	...
	<div id="wrapper">
        ...
        <content tag="local_script"> 
			...
			<script src="<c:url value='/js/trunk/tmpBank/list.js' />"></script> 
			...
			<script src="<c:url value='/js/workflow/myCaseList.js' />"></script>
