			...
			<div class="line">
				<div class="add_btn" style="margin-left: 128px;">
					...
					<button type="button" id="mortgageInfoToExcel"
							...
							onclick="javascript:mortgageInfoToExcel()">实时导出列表</button>
					<button type="button" id="mortgageInfoToExcelB" class="btn btn-success">隔天导出列表</button>
...
<content tag="local_script">
	...
	<script src="<c:url value='/js/trunk/task/mortgageInfo_list2.js' />"></script>
