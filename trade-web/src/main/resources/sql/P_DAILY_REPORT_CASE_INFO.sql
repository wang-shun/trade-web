...
SELECT
		...
		case
			...
			when  MG.MORT_TYPE='30016002' then (MORT_TOTAL_AMOUNT-convert(decimal(18, 2),isnull(MG.PRF_AMOUNT,0)))
			else 0
		end MORTGAGET_COM_AMOUNT,--商业款金额
		case
			when  MG.MORT_TYPE='30016003' then MG.MORT_TOTAL_AMOUNT else 0 
