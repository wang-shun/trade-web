USE [sctrans_dev]
GO
/****** Object:  StoredProcedure [sctrans].[P_DAILY_REPORT_CASE_INFO]    Script Date: 2017/2/7 19:29:13 ******/
SET ANSI_NULLS ON
GO
...
SELECT
		...
		case 
			when CA.LOAN_REQ=1 and MG.IS_DELEGATE_YUCUI=1 and (MG.MORT_TYPE='30016001' or MG.MORT_TYPE ='30016002' ) THEN  0 --没流失的金额
			when CA.LOAN_REQ=1 and  MG.IS_DELEGATE_YUCUI=0 and (MG.MORT_TYPE='30016001' or MG.MORT_TYPE ='30016002' ) THEN  MG.COM_AMOUNT--流失的金额
