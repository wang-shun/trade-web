...
public class ProcessWaitTimeJob implements Job {
	...
	public synchronized void execute(JobExecutionContext context) {
		...
		// 获取所有待处理产调
		List<ToPropertyResearch> propertys =  toPropertytService.queryAllProperty("0");
