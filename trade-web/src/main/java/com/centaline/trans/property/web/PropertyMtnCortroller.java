...
public class PropertyMtnCortroller {
	...
	@ResponseBody
	public AjaxResponse<ToPropertyResearch> updateProcessingListStatus(Model model, ServletRequest request,String pkidList){
		AjaxResponse<ToPropertyResearch> result = new AjaxResponse<>();
	...
	@ResponseBody
	public AjaxResponse<ToAttachment> saveFiles(Model model, ServletRequest request,@RequestBody ToAttachment toAttachment){
