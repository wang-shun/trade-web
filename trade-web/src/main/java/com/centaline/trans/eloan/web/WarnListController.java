...
public class WarnListController
{
    ...
    public String eloanApply(HttpServletRequest request, HttpServletResponse response, String businessKey, String taskitem, String processInstanceId)
    {
        SessionUser user = uamSessionService.getSessionUser();
        ...
        request.setAttribute("excutorCode", user.getEmployeeCode());
    ...
    public String newEloanApply(HttpServletRequest request, HttpServletResponse response, String businessKey, String taskitem, String processInstanceId)
    {
        SessionUser user = uamSessionService.getSessionUser();
        Org parentOrg = uamUserOrgService.getParentOrgByDepHierarchy(user.getServiceDepId(), DepTypeEnum.TYCQY.getCode());
        request.setAttribute("orgId", parentOrg.getId());
    ...
    {
        /*
         * public String modifyEloanCaseInfo(@RequestBody ToEloanRelListVO
         * eloanRelListVO){
         */
    ...
    public String eloanApplyConfirm(HttpServletRequest request, HttpServletResponse response, String businessKey, String taskitem, String processInstanceId)
    {
    ...
    @ResponseBody
    /*
     * Model model,String taskId,String approved,String eloanCode,String
    ...
    public AjaxResponse<String> saveEloanApplyConfirm(ToEloanCase eloanCase, String eContent, String taskId, String param, String approved)
    {
        ...
        try
        {
            ...
            if (null != eloanCase)
            {
                toEloanCase.setEloanCode(eloanCase.getEloanCode() == null ? "" : eloanCase.getEloanCode());
                /*
                 * toEloanCase.setCustName(eloanCase.getCustName()==null?"":
                 * eloanCase.getCustName());
                 * toEloanCase.setApplyAmount(eloanCase.getApplyAmount());
                 * toEloanCase.setCustPhone(eloanCase.getCustPhone()==null?"":
                 * eloanCase.getCustPhone());
                 * toEloanCase.setMonth(eloanCase.getMonth());
                 */
            }
    ...
    public String eloanSign(HttpServletRequest request, HttpServletResponse response, String businessKey, String taskitem, String processInstanceId)
    {
        setAttribute(request, response, businessKey, taskitem, processInstanceId);
    ...
    private void setAttribute(HttpServletRequest request, HttpServletResponse response, String businessKey, String taskitem, String processInstanceId)
    {
        ...
        request.setAttribute("excutorCode", excutor.getEmployeeCode());
    ...
    public String eloanSignConfirm(HttpServletRequest request, HttpServletResponse response, String businessKey, String taskitem, String processInstanceId)
    {
        setAttribute(request, response, businessKey, taskitem, processInstanceId);
    ...
    @ResponseBody
    /*
     * public AjaxResponse<String> saveEloanSignConfirm(Model model,String
     * taskId,String approved,String eloanCode){
     */
    ...
    public String eloanRelease(HttpServletRequest request, HttpServletResponse response, String businessKey, String source, String taskitem,
    ...
    public AjaxResponse<String> saveEloanRelease(Model model, @RequestBody ToEloanRelListVO eloanRelListVO)
    {
        try
        {
            ...
            /*
             * toEloanCaseService.eloanProcessConfirm(eloanRelListVO.getTaskId()
             * , map, eloanRelListVO.getToEloanCase(),true);
             */
    ...
    public String eloanReleaseConfirm(HttpServletRequest request, HttpServletResponse response, String businessKey, String taskitem, String processInstanceId)
    {
        setAttribute(request, response, businessKey, taskitem, processInstanceId);
        // 显示所有放款金额
        List<ToEloanRel> eloanRelList = toEloanRelService.getEloanRelByEloanCode(businessKey);
    ...
    @ResponseBody
    /*
     * public AjaxResponse<String> saveEloanReleaseConfirm(Model model,String
     * taskId,String approved,String eloanCode,String processInstanceId){
     */
    ...
    public String eloanContractList(HttpServletRequest request)
    {
        ...
        request.setAttribute("queryOrgFlag", queryOrgFlag);// 判断是否是交易顾问
                                                           // 即判断是否有上下级组织
        ...
        /*
         * 获取当前月份的上月第一天和最后一天 c1.add(Calendar.MONTH, -1);
         * c1.set(Calendar.DAY_OF_MONTH,1); c2.set(Calendar.DAY_OF_MONTH,0);
         */
        /* 获取当前月份的第一天和最后一天 */
    ...
    private boolean getApproveRecordForItem(ToApproveRecord toApproveRecord, HttpServletRequest request)
    {
        ...
        /*
         * ToApproveRecord toApproveRecord2=toApproveRecordService.
         * queryToApproveRecordForSpvApply(toApproveRecord); if(toApproveRecord
         * != null){ flag=true; request.setAttribute("toApproveRecord",
         * toApproveRecord2); }
         */
