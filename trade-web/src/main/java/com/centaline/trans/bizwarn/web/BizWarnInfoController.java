...
public class BizWarnInfoController {
	...
	@ResponseBody
	public AjaxResponse editBizWarnInfo(ServletRequest request,BizwarnForm bizwarnForm){
		AjaxResponse result = new AjaxResponse();
		
		BizWarnInfo bizWarnInfo = bizWarnInfoService.getBizWarnInfoByCaseCode(bizwarnForm.getCaseCode());
	...
	@ResponseBody
	public AjaxResponse addBizWarnInfo(ServletRequest request,BizwarnForm bizwarnForm){
		AjaxResponse result = new AjaxResponse();
		
		SessionUser currentUser = uamSessionService.getSessionUser();
		ToCase toCase = toCaseService.findToCaseByCaseCode(bizwarnForm.getCaseCode());
