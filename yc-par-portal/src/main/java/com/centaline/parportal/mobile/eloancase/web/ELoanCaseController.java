...
public class ELoanCaseController {
	...
	@ResponseBody
	public String suppleInfo(String eLoanCode, String type, String stateInBank, String caseCode, String comment) {

		if (eLoanCode == null || type == null || comment == null || stateInBank == null || caseCode == null) {
	...
	public String list(Integer page, Integer pageSize, String sidx, String sord, String condition) {
		...
		// 查询未接单E+列表信息
		Page<Map<String, Object>> noAcceptELoanCaseMapList = quickGridService.findPageForSqlServer(gp, sessionUser);
		...
		List<Map<String, Object>> noAcceptELoanCaseList = noAcceptELoanCaseMapList.getContent();
	 ...
	 * @return
	 */
	private String bulidELoanCaseDetailByJson(String eLoanCode, List<Map<String, Object>> eLoanCaseDetailMapList, List<Map<String, Object>> eLoanCaseProcessMapList, List<Map<String, Object>> eLoanCaseTradeProcessMapList) {
