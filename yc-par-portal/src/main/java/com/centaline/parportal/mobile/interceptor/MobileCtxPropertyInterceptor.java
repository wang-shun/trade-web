...
@Intercepts({ @Signature(type = StatementHandler.class, method = "prepare", args = { Connection.class,
                                                                                     Integer.class }) })
public class MobileCtxPropertyInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        StatementHandler delegate = (StatementHandler) ReflectHelper.getFieldValue(handler,
            "delegate");
        ...
        try {
            ...
            sessionUserId = sessionUser == null ? "SYSTEM" : sessionUser.getId();
        } catch (Exception e) {
