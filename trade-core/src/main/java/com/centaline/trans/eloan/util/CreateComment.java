...
public class CreateComment {
	...
	public static String createMmComment(ToRcMortgageInfo toRcMortgageInfo){
		String comment = null;
		if(MortgageCategoryEnum.CARDED.equals(toRcMortgageInfo.getMortgageCategory())) {
			comment = "身份证姓名:"+toRcMortgageInfo.getReferName()+";身份证号码:"+ toRcMortgageInfo.getReferCode();
			
		} else if(MortgageCategoryEnum.BANKCARD.equals(toRcMortgageInfo.getMortgageCategory())) {
			comment = "户名:"+toRcMortgageInfo.getReferName()+";银行卡号:"+ toRcMortgageInfo.getReferCode();
		} else if(MortgageCategoryEnum.PROPERTY_CARD.equals(toRcMortgageInfo.getMortgageCategory())) {
			comment = "产权编号:"+toRcMortgageInfo.getReferCode()+";产权人姓名:"+ toRcMortgageInfo.getReferName()+";房屋地址:"+toRcMortgageInfo.getReferAddreass();
		} else if(MortgageCategoryEnum.OTHER_CARD.equals(toRcMortgageInfo.getMortgageCategory())) {
