...
public class EditCaseDetailServiceImpl implements EditCaseDetailService
{
    ...
    public EditCaseDetailVO queryCaseDetai(String caseCode)
    {
        ...
        // tgGuestInfoMapper.findTgGuestInfoByCaseCode(caseCode);
        ...
        if(toRansomFormVo != null) {
        	...
        	ToRansomVo toRansomVo = ransomListFormMapper.getRansomInfoByRansomCode(toRansomFormVo.getRansomCode()).get(0);
        	if(toRansomVo != null) {
