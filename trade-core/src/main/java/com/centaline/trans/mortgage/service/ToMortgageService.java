...
public interface ToMortgageService {
     ...
     *  @param toMortgage
     */
    void submitMortgage(ToMortgage toMortgage, List<RestVariable> variables, String taskId,
     ...
     * @return
     */
    AjaxResponse<?> tmpBankThriceAduit(ToMortgage mortage, String prAddress, String tmpBankName,
                                       String tmpBankCheck, String taskId, String bankCode,
    ...
    /**
     * 合作机构人员增加按揭贷款环节跟进
     * 插入comment， 更新mortgage的stateInBank
     * @param record
     * @return
     */
