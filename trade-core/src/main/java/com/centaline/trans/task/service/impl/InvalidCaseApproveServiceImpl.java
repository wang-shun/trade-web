...
@Transactional
@Service
public class InvalidCaseApproveServiceImpl implements InvalidCaseApproveService {
	...
	@Override
	public Boolean invalidCaseApprove(ProcessInstanceVO processInstanceVO, LoanlostApproveVO loanlostApproveVO,
			String InvalidCaseApprove, String InvalidCaseApprove_response) {
		ToApproveRecord toApproveRecord = saveToApproveRecord(processInstanceVO, loanlostApproveVO, InvalidCaseApprove,
		...
		boolean wfm = workFlowManager.submitTask(variables, processInstanceVO.getTaskId(),
				processInstanceVO.getProcessInstanceId(), toCase.getLeadingProcessId(),
