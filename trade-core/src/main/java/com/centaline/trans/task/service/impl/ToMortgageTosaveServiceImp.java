...
@Service
public class ToMortgageTosaveServiceImp implements ToMortgageTosaveService {
	...
	@Override
	public boolean submit(MortgageToSaveVO vo) {
		List<RestVariable> variables = new ArrayList<RestVariable>();
		RestVariable  restVariable = new RestVariable();
		String selfMort = vo.getSelfMort(); // 1自办 0代办
		boolean b = false;
		if("1".equals(selfMort)){
			restVariable.setName("redeemSuccess");
	...
	public void loanRequirementChange(MortgageToSaveVO vo) {
...
/*				wf.setBusinessKey(WorkFlowEnum.NEWLOANLOST_PROCESS.getName());
		 ...
		 * @param vo
		 */
		private void doBusiness(MortgageToSaveVO vo) {
