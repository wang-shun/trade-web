...
public enum CcaiTaskEnum {
	...
	//评估返利 流程环节
	EVA_REBATE_ASSISTANT("内勤确认",CcaiFlowEnum.EVA_REBATE),
	//评估退费 流程环节
	EVA_REFUND_MANAGER("权证经理审批",CcaiFlowEnum.EVA_REFUND),
	EVA_REFUND_MAJORDOMO("权证总监审批",CcaiFlowEnum.EVA_REFUND),
	//银行返利 流程环节
	...
	//变更自办评估 流程环节
	EVA_CUSTOMER_MANAGER("权证经理审批",CcaiFlowEnum.CHANGETO_CUSTOMER_EVA),
	EVA_CUSTOMER_MAJORDOMO("权证总监审批",CcaiFlowEnum.CHANGETO_CUSTOMER_EVA),
	//变更自办贷款 流程环节
