...
public class QuickQueryUserByUsernameCustomDictServiceImpl implements CustomDictService{
	...
	@Override
	@Cacheable(value="QuickQueryUserByUsernameCustomDictServiceImpl",key="#root.target.getProp()+'/'+#keys")
