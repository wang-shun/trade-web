...
public class QuickQueryMortTypeCustomDictServiceImpl implements CustomDictService{
	...
	/*@Override
	@Cacheable(value="QuickQueryMortTypeCustomDictServiceImpl",key="#root.target.getDictType()+'/'+#key")
